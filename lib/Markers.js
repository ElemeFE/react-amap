...
import clusterIcon from './assets/map_cluster.png';
import waitIcon from './assets/map_wait.png';
import waitHoverIcon from './assets/map_wait_emphsis.png';
import selectedIcon from './assets/map_selected.png';
import selectedHoverIcon from './assets/map_selected_emphsis.png';
// import css from './assets/marker.css';

require('./assets/marker.css');
...
class Markers extends Component {
  constructor(props) {
    ...
    if (!props.__map__) {
      ...
      this.useCluster = defaultOpts.useCluster;
